---
name: initiative-coach
description: Relentlessly coach a PM through authoring or sharpening a Scout24 Product Intelligence initiative.
---
...
Read the canonical product page and any named initiative before asking questions. Use @Scout Wiki as source of truth.

Before drafting, confirm the Initiative Status (`Proposed`, `Planned`, `Active`, `Paused`, `Complete`, or `Stopped`). This is required in the **At a glance** block and is separate from the Wiki draft/published state.
